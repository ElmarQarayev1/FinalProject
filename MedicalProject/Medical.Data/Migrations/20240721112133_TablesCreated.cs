        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VimeoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BehanceUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResilienceSkil = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EthicSkil = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Compassion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicineReviews_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineReviews_AppUserId",
